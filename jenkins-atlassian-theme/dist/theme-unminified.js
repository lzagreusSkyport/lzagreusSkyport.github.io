...
function writeCookie(e, t, n) {
    var o, i;
    n ? (o = new Date, o.setTime(o.getTime() + 1e3 * 60 * 60 * 24 * n), i = "; expires=" + o.toGMTString()) : i = "", document.cookie = e + "=" + t + i + "; path=/"
}
...
jQuery(function(e) {
    ...
    if ("/login" == window.location.pathname) {
        ...
        var o = e('input[name="j_username"]').closest("td").prev("td").addClass("input-label"),
            i = e('input[name="j_password"]').closest("td").prev("td").addClass("input-label");
        e("a[href=signup]").closest("div").addClass("signup-container"), e("#yui-gen1-button").addClass("login-button");
        var r = e(".submit-button"),
            a = e("#main-panel div:first").addClass("login-container"),
            l = e('form[name="login"]').length;
        l && (o.text("Username"), i.text("Password"), a.removeAttr("style"), a.wrap(t("login-outer")), a.wrap(t("login-wrapper").prepend(" <h2> " + n + " </h2> ")), r.wrap(t("button-wrapper")), e(".login-container div:last").removeAttr("style"))
    }
}), jQuery(function(e) {
